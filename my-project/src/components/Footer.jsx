  ...
  return (
    <div className="bg-white p-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-10">
        <div>
          <h4 className="my-3">Hỗ trợ khách hàng</h4>
          <p className="hotline">
            Hotline: <a href="tel:1900-6035">1900-6035</a>
            <p className="small-text">(1000 đ/phút, 8-21h kể cả T7, CN)</p>
          </p>
          <p>Các câu hỏi thường gặp</p>
          <p>Gửi yêu cầu hỗ trợ</p>
          <p href="">Hướng dẫn đặt hàng</p>
          <p href="">Phương thức vận chuyển</p>
          <p href="">Chính sách đổi trả</p>
          <p href="">Hướng dẫn trả góp</p>
          <p href="">Chính sách hàng nhập khẩu</p>
          <p href="">Hỗ trợ khách hàng: hotro@tiki.vn</p>
          <p href="">Báo lỗi bảo mật: security@tiki.vn</p>
        </div>
        <div>
          <h4 className="my-3">Về Tiki</h4>
          <p href="">Giới thiệu Tiki</p>
          <p href="">Tiki Blog</p>
          <p href="">Tuyển dụng</p>
          <p href="">Chính sách bảo mật thanh toán</p>
          <p href="">Chính sách bảo mật thông tin cá nhân</p>
          <p href="">Chính sách giải quyết khiếu nại</p>
          <p href="">Điều khoản sử dụng</p>
          <p href="">Giới thiệu Tiki Xu</p>
          <p href="">Tiếp thị liên kết cùng Tiki</p>
          <p href="">Bán hàng doanh nghiệp</p>
          <p href="">Điều kiện vận chuyển</p>
        </div>
        <div>
          <h4 className="my-3">Hợp tác và liên kết</h4>
          <p href="">Quy chế hoạt động Sàn GDTMĐT</p>
          <p href="">Bán hàng cùng Tiki</p>
          <h4 className="my-3">Chứng nhận bởi</h4>
          <p
        ...
        <div>
          <h4 className="my-3">Phương thức thanh toán</h4>
          <h4 className="my-3">Dịch vụ khách hàng</h4>
        </div>
        <div>
          ...
          <h4 className="my-3">Tải ứng dụng trên điện thoại</h4>
        </div>
      </div>
      <hr className="my-6" />
      <div>
        <h4 className="my-3">Công ty TNHH TIKI</h4>
        <p>
